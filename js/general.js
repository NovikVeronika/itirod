...
export const emailInput = document.querySelector("#emailInput")

export const wrongEmail = document.querySelector('#wrongEmail')
export const wrongPassword = document.querySelector('#wrongPassword')
export const noUser = document.querySelector('#noUser')
export const wrongData = document.querySelector('#wrongData')
export const weakPassword = document.querySelector('#weakPassword')
